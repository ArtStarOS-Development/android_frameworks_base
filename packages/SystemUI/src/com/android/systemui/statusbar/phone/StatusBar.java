...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mArtstarSettingsObserver.observe();
        mArtstarSettingsObserver.update();
    ...
    private ArtstarSettingsObserver mArtstarSettingsObserver = new ArtstarSettingsObserver(mHandler);
    private class ArtstarSettingsObserver extends ContentObserver {
        ArtstarSettingsObserver(Handler handler) {
            super(handler);
        }
